...
<div class="container">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h1 class="col-md-8 offset-md-4">Rekomendasi Buku</h1>
            <hr>

            <!-- Display search form -->
            <form action="{{ route('buku.public.index') }}" method="GET" class="mb-3">
                <div class="input-group">
                    <input type="text" class="form-control mr-4" placeholder="Cari judul, pengarang, atau penerbit..."
                        name="search">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('buku.public.show', $b->id) }}" class="btn btn-danger">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                @endforeach
